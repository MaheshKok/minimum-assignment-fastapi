...
This class loads configuration data from TOML files and provides
...
class Config:
    ...
    def load_string(cls, text: str, **kwargs) -> dict:
        ...
        try:
            ...
            logging.getLogger("minimum.config").exception(e)
            return {}
...
def get_config(config_file: str = ConfigFile.DEVELOPMENT) -> Config:
    """
